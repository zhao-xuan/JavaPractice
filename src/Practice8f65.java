...
public class Practice8f65 {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("%s - %s - skill: %d; stamina: %d; luck: %s", joe.getName(), joe.getType(), joe.getSkill(), joe.getStamina(), joe.getLuck()));
        System.out.println(String.format("%s - %s - skill: %d; stamina: %d; luck: %s", alex.getName(), alex.getType(), alex.getSkill(), alex.getStamina(), alex.getLuck()));
        System.out.println("------------------------------");
    ...
    public static boolean simulateBattle(Fighter first, Fighter second) {
        ...
        if (firstAttack == secondAttack) {
            ...
            System.out.println(String.format("%s - %s - skill: %d; stamina: %d; luck: %s", first.getName(), first.getType(), first.getSkill(), first.getStamina(), first.getLuck()));
            System.out.println(String.format("%s - %s - skill: %d; stamina: %d; luck: %s", second.getName(), second.getType(), second.getSkill(), second.getStamina(), second.getLuck()));
        }
